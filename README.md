...
**NOTE:** this now automatically starts via [`concurrently`](https://github.com/open-cli-tools/concurrently) when running `npm run dev` as [described above](#start-storefront-svelte-kit).
